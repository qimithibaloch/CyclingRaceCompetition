...
public class IntermediateCyclist extends Cyclist {
    private int[] scores;
     ...
     * @param scores           
     */
    public IntermediateCyclist(int cyclistNumber, String name, String email, int age, String gender, String country, String category, String level, int[] scores) {
